...
public class RpcDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        ...
        MessageType messageType = MessageType.getMessageTypeByTypeCode(messageTypeCode);
        if (serializerTypeCode != serializer.serializerTypeCode()){
        ...
        Class<? extends RpcMessage> bindingClassType = messageType.getBindingClassType();
        //读取消息具体内容
