package cn.ice0qw3.netty.rpc.ref.server;
...
public class BeanAndMethod {
    ...
    public Object invokeMethod(Object[] parameters , Class<?>[] requireParameterTypes) {
        ...
        logger.info("尝试执行请求的方法 , 请求的参数为：" +
                "{} ,请求的类型为：{},方法的实际类型为:{}", Arrays.toString(parameters), Arrays.toString(requireParameterTypes), Arrays.toString(parameterTypes));
